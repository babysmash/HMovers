...
- (void)viewDidLoad {
    ...
    self.sztTextView =[[SZTextView alloc]initWithFrame:CGRectMake(10,SH_TopHeight+5, WIDTH-20, 150)];
    ...
    self.sztTextView.layer.borderColor = [UIColor lightGrayColor].CGColor;
    self.sztTextView.backgroundColor = [UIColor lightGrayColor];
